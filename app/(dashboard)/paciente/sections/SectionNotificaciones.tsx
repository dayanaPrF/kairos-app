...
export function SectionNotificaciones() {
  ...
  const filtradas = notificaciones.filter(n => {
    if (filtrando === 'no_leidas') return n.estado !== 'leida'
    if (filtrando === 'leidas') return n.estado === 'leida'
    return true
  })
            ...
            return (
              ...
              >
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  <div style={{
                    marginTop: '4px', fontSize: '0.84rem',
                    color: leida ? '#aaa' : '#555', lineHeight: 1.5,
                  }}>
                    {n.mensaje}
                  </div>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginTop: '8px' }}>
                    <span style={{
                      ...
                      letterSpacing: '0.05em', color: color,
                      background: `${color}12`, padding: '2px 8px', borderRadius: '6px',
                    }}>
                      {n.tipo}
                    </span>
                    {!leida && (
                      <span style={{ fontSize: '0.75rem', color: '#5499C7' }}>
